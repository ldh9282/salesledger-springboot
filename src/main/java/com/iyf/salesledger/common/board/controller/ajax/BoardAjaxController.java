...
public class BoardAjaxController {
	...
	public void insertBoard(@RequestBody CustomMap requsetMap, HttpServletRequest request) {
	...
	public void updateBoard(@PathVariable long board_id, @RequestBody CustomMap requsetMap, HttpServletRequest request) {
