...
<head>
  ...
  <title>게시판 등록페이지: IYF 영업관리시스템</title>
	...
	<main id="main" class="main" style="width: 80vw;">
        ...
        <div class="mt-5 mb-3">
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="boardType" id="discussion" value="01" checked>
	            <label class="form-check-label" for="discussion">일반</label>
	        </div>
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="boardType" id="question" value="02">
	            <label class="form-check-label" for="question">질문</label>
	        </div>
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="boardType" id="announcement" value="03">
    ...
    $(document).ready(function() {
    	...
    	$('#btnRegister').click(function() {
    		...
    		const board = {
   			...
   			$.ajax({
   			    type: 'POST',
   			    url: '${pageContext.request.contextPath}/board.ajax',
    	...
    	$('#btnCancle').click(function() {
    		if (!confirm('작성 중인 게시글 등록을 취소하시겠습니까?')) {
    			return;
    		}
    		window.location.href = '${pageContext.request.contextPath}/board/list';
    	});
