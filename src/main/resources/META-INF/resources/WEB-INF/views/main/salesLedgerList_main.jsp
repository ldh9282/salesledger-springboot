...
<!--             <div class="container"> -->
				<div id="title" class="d-flex justify-content-center" style="width: 80vw;">
			  		<span style="font-size: 20px; font-weight: 550; color: #012970c7; font-family: 'Nunito', sans-serif;">${company} ${department_kr} 용역원가 [매출원장]</span>
				</div>
...
<!--         </section> -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // 그리드 데이터 ajax로 가져오기
            $.ajax({
                url: "${pageContext.request.contextPath}/salesLedger.ajax/company/${company}/department/${department}",
                method: "GET",
            ...
            $('a[data-bs-target="#${company_lower}-${department_lower}-nav"]').attr('class', 'nav-link');
       		...
       		$('ul#${company_lower}-${department_lower}-nav li:eq(1) a').attr('class', 'active');
